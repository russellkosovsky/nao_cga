...
activation = [-0.034, # left hip roll
              -0.518, # left hip pitch
              1.047,  # left knee pitch
              -0.529, # left ankle pitch
              0.034,  # left ankle roll
              
              -0.034, # right hip roll
              -0.518, # right hip pitch
              1.047,  # right knee pitch
              -0.529, # right ankle pitch
              0.034,  # right ankle roll
